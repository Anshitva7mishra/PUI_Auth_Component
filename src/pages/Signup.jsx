      ...
      >
        <div className="w-full lg:w-[45%] p-8 md:p-12 flex flex-col justify-between relative z-10 bg-[#0f0f11]">
          <div className="flex justify-between items-center mb-8">
            <button className="cursor-pointer p-2 rounded-full border border-white/10 hover:bg-white/5 transition text-gray-400 hover:text-white">
              <ArrowLeft size={20} />
            </button>
          ...
          <div className="flex flex-col grow max-w-md mx-auto w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              >
                <div
                  className={`flex items-center gap-4 border-b py-3 transition-all duration-300 ${
                    focusedField === "name"
              ...
              >
                ...
                <div className="mt-3 flex items-center gap-2 text-xs text-gray-500 font-medium">
                  ...
                  <span>Min. 8 chars, mixed case & symbols required.</span>
                </div>
              </motion.div>
              ...
              <div className="pt-6 flex flex-col sm:flex-row items-center gap-6">
                ...
                >
                  <div className="absolute inset-0 bg-linear-to-r from-blue-600 to-blue-400 group-hover:from-blue-500 group-hover:to-blue-300 cursor-pointer transition-all duration-300" />
                  <span className="cursor-pointer relative z-10">Sign Up</span>
          ...
          <div className="relative z-10 w-full h-full">
            ...
            >
              <div className="relative group">
                <div className="absolute -inset-1 bg-linear-to-r from-blue-600 to-indigo-600 rounded-3xl blur opacity-40 group-hover:opacity-75 transition duration-1000 group-hover:duration-200" />
